...
export const TimeFilter = ({ currentRange, onRangeChange }) => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {/* Dropdown Content */}
      {isOpen && (
        <div className="absolute right-0 mt-3 w-full md:w-80 bg-white border border-slate-100 rounded-[2rem] shadow-2xl shadow-slate-300/50 z-50 overflow-hidden animate-fade-in ring-1 ring-black/5">
          {/* Header */}
          ...
          {/* Presets Grid */}
          <div className="p-4">
            <p className="px-2 py-1 text-[10px] text-slate-400 font-bold uppercase tracking-wider mb-2">
              Preset Cepat
            </p>
            ...
            <div className="px-1">
              <p className="px-1 py-1 text-[10px] text-slate-400 font-bold uppercase tracking-wider mb-2">
                Rentang Kustom
              </p>
              <div className="flex gap-3">
                <div className="space-y-1.5 flex-1">
                  <label className="text-[10px] text-slate-400 uppercase font-black tracking-widest ml-1">
                    Dari
                  </label>
                  <input
                    type="date"
