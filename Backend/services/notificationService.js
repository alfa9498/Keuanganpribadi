 ...
 * @param {string} message - Message content
 * @param {string} [specificChatId] - Optional specific chat ID (for user-specific messages)
 */
const sendTelegram = async (message, specificChatId = null) => {
  ...
  try {
    ...
    console.log(`[TELEGRAM SENT] to ${targetChatId}: ${message}`);
    return true;
  } catch (error) {
    console.error(
